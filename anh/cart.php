...
<table>
    ...
    <form action="xlcart.php" method="POST">
        <?php
        $total = 0;
        ...
        ?>
            <tr>
                ...
                <td align="center" class="cartpro">
                    <input class="incart" type="text" name="soluon[<?php echo $row['id_cart'] ?>]" value="<?php echo $row['soluong'] ?>">
                </td>
                <td align="center" class="cartpro"><?php echo $kq ?>.000Vnd</td>
                <td align="center" class="cartpro"><a href="./xlcart.php?delete=<?php echo $row['id_cart'] ?>">XOA</a></td>
            </tr>
        <?php
            $total = $total + $kq;
        }
...
<div class="cncart">
    ...
    <div style="float: right;">
        <input class="btcart" style="background-color: aqua;" type="submit" name="update" value="Cập Nhật">
        </form>
        <button class="btcart" style="background-color:  red;"><a href="./vnpay_php/" style="color: white;">Thanh Toán</a></button>
    </div>
    <table></table>
</div>
